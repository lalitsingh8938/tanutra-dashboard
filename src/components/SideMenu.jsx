...
function SideMenu() {
  ...
  return (
    <aside
      ref={sidebarRef}
      className={`${menuWidth} h-screen fixed top-20 left-0 bg-slate-100 overflow-y-hidden transition-transform duration-500 z-40 md:block ${isOpen ? 'block' : 'hidden'}`}
    >
      {/* Profile Section */}
      <div className="flex">
        <img
...
//     <aside
//       ref={sidebarRef}
//       className={`${menuWidth} h-screen fixed top-0 left-0 bg-slate-100 overflow-y-hidden transition-transform duration-500 z-40 lg:top-20 lg:w-[231px] lg:block ${isOpen ? "block" : "hidden"}`}
//     >
//       {/* Profile Section */}
//       <div className="flex">
//         <img
...
//       <button
//         className="lg:hidden p-4 text-white bg-indigo-800 fixed top-4 left-4 z-50"
//         onClick={toggleMenu}
//       >
//         {isOpen ? (
