...
//                       value={formData.category}
//                       onChange={handleChange}
//                       className="w-full h-9 p-3 border-none rounded-l-md focus:outline-none"
//                     />
//                     <IoMdArrowDropdown className="mr-3 w-6 h-6 text-gray-600 opacity-70" />
//                   </div>
//                 </div>
//               </div>
...
//               <div className="flex flex-col w-72 ml-72 items-center">
//                 <label className="font-semibold text-slate-800 p-2">
//                   quantity_available:
//                 </label>
//                 <input
...
//                 <button
//                   type="submit"
//                   className="text-white font-semibold bg-green-500 py-2 w-44 px-6 rounded-lg"
//                   disabled={isLoading}
//                 >
...
//           <div className="flex flex-col w-72">
//             <label className="font-semibold text-slate-800 p-2">Category</label>
//             <select
//               value={formData.category}
//               placeholder="Home Decor"
//               onChange={handleCategoryChange}
