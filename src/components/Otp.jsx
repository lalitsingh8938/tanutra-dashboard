...
//     if (!email) {
//       setErrorMessage("Email not found. Please restart the process.");
//       // localStorage.setItem("email", userEmail); // Set email after user input
//       navigate("/otp"); // Navigate to OTP component
...
//       if (response.status === 200) {
//         alert("OTP verified successfully!");
//         const receivedToken = response.data.token; // Assuming token is in response.data.token
...
//   const sendNextRequest = async (password, confirmPassword) => {
//     const email = localStorage.getItem("email");
