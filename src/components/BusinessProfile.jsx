...
const BusinessProfile = () => {
  ...
  useEffect(() => {
    const fetchCities = async () => {
      if (selectedState) {
        const cities = await City.getCitiesOfState(selectedCountry, selectedState);
        setCities(cities);
      }
    };
    fetchCities();
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setFormData({
          ...formData,
          brand_logo: base64Image, // Store Base64 encoded string in formData
        });

        setImage(base64Image); // Optional: Show a preview of the image
      };
  ...
  const handleSubmit = (e) => {
    ...
    const formDataToSend = {
      legal_business_name: formData.legal_business_name,
      brand_name: formData.brand_name,
      brand_logo: formData.brand_logo, // Send as Base64
      gst_no: formData.gst_no,
      business_id: formData.business_id,
      business_full_addr: [formData.business_full_addr],
    };
    ...
    localStorage.setItem("gst_no", formData.gst_no);
    localStorage.setItem("business_id", formData.business_id);
    localStorage.setItem("business_full_addr", JSON.stringify(formData.business_full_addr));
          ...
          <div className="rounded-xl bg-transparent p-2 border">
            <form onSubmit={handleSubmit} className="mt-12 bg-transparent">
              ...
              <div className="flex flex-wrap justify-center items-start gap-8 mt-6">
                ...
                <div className="flex flex-col w-72">
                  <div className="font-semibold text-slate-800 p-2">GST No</div>
                  <input
                    type="text"
                    name="gst_no"
                    value={formData.gst_no}
                ...
                <div className="flex flex-col w-72">
                  <div className="font-semibold text-slate-800 p-2">
                    Business ID
                  </div>
                  <input
                    type="text"
              ...
              <div className="flex flex-wrap justify-center items-start gap-8 mt-6">
                ...
                <div className="flex flex-col w-72">
                  <div className="font-semibold text-slate-800 p-2">Pincode</div>
                  <input
                    type="text"
                    name="pincode"
                    value={formData.business_full_addr.pincode}
              ...
              <div className="flex flex-wrap justify-center items-start gap-8 mt-6">
                <div className="flex flex-col w-72">
                  <div className="font-semibold text-slate-800 p-2">Country</div>
                  <select
                    name="country"
                    value={selectedCountry}
                    onChange={handleCountryChange}
                ...
                <div className="flex flex-col w-72">
                  <div className="font-semibold text-slate-800 p-2">State</div>
                  <select
                    name="state"
                    value={selectedState}
                    onChange={handleStateChange}
                ...
                <div className="flex flex-col w-72">
                  <div className="font-semibold text-slate-800 p-2">City</div>
                  <select
                    name="city"
                    value={formData.business_full_addr.city}
                    onChange={handleCityChange}
              ...
              <div className="flex justify-center mt-8">
                <button
                  type="submit"
                  className="bg-[#F5A623] px-6 py-3 rounded-lg text-white font-semibold"
                >
                  Save & Continue
                </button>
              </div>
