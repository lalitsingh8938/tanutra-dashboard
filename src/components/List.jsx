...
//       {/* Cards Row */}
//       <div className="flex flex-wrap gap-3 ml-3 mt-4 lg:w-[800px] ">
//         {/* Card 1 */}
    ...
    <div className="flex flex-col h-auto w-full sm:w-[350px] lg:w-[800px] md:w-[500px]  mt-20 ml-[260px] bg-[#FFFCF4] rounded-md">
      ...
      <div className="flex ml-1 mt-3">
        <img
          ...
          alt="logo"
        />
        <p className="ml-4 mt-3 font-semibold text-lg opacity-90 w-28">To do list</p>
      </div>
      ...
      <div className="flex flex-wrap gap-3 ml-3 mt-4 justify-start">
        ...
        <div className="flex h-20 w-full sm:w-[170px] md:w-[185px] bg-white border rounded-lg">
          ...
          />
          <div className="">
            <p className="mt-3 ml-4 font-normal text-sm opacity-65">Pending Orders</p>
            <p className="flex items-center">
              <h4 className=" ml-4 text-indigo-800">0</h4>
              <HiMiniChevronRight className="w-5 h-5 ml-1 cursor-pointer text-indigo-800" />
            </p>
        ...
        <div className="flex h-20 w-full sm:w-[170px] md:w-[185px] bg-white border rounded-lg">
          ...
          />
          <div>
            <p className="mt-3 ml-4 font-normal text-sm opacity-65">Download Labels</p>
            <p className="flex items-center">
        ...
        <div className="flex h-20 w-full sm:w-[170px] md:w-[185px] bg-white border rounded-lg">
          ...
          />
          <div>
            <p className="mt-3 ml-4 font-normal text-sm opacity-65">Out of Stocks</p>
            <p className="flex items-center">
              <h4 className="text-indigo-800 ml-4">0</h4>
              <HiMiniChevronRight className="w-5 h-5 ml-1 cursor-pointer text-indigo-800" />
            </p>
        ...
        <div className="flex h-20 w-full sm:w-[170px] md:w-[185px] bg-white border rounded-lg">
          ...
          />
          <div>
            <p className="mt-3 ml-4 font-normal text-sm opacity-65">Low Stock</p>
            <p className="flex items-center">
              <h4 className="text-indigo-800 ml-4">0</h4>
              <HiMiniChevronRight className="w-5 h-5 ml-1 cursor-pointer text-indigo-800" />
            </p>
